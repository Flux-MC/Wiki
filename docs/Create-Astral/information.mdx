...
### World Border
The world border is currently set to a 8,000 block radius from 0,0. This is subject to change.

### Sleep Percentage
The sleep percentage is currently set to 1%. This is subject to change.
